...
public class LinkedQueueTest extends LinkedQueue {
    LinkedQueue<String> deque = new LinkedQueue<>();
    ...
    @Test
    public void testRemoveLastOccurrence() throws NoSuchElementException {
/*        boolean expected = false;
    ...
    @Test
    public void testRemoveFirstOccurrence() throws NoSuchElementException {
        boolean expected = false;
